...
[![Socket Badge](https://socket.dev/api/badge/npm/package/@ilihub/dot-case-string-to-path-case-string)](https://socket.dev/npm/package/@ilihub/dot-case-string-to-path-case-string)
