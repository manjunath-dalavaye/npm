...
[![Socket Badge](https://socket.dev/api/badge/npm/package/@ilihub/kebab-case-string-to-dot-case-string)](https://socket.dev/npm/package/@ilihub/kebab-case-string-to-dot-case-string)
