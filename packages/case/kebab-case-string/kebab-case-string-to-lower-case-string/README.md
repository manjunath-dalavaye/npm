# @ilihub/kebab-case-string-to-lower-case-string
...
[![Socket Badge](https://socket.dev/api/badge/npm/package/@ilihub/kebab-case-string-to-lower-case-string)](https://socket.dev/npm/package/@ilihub/kebab-case-string-to-lower-case-string)
