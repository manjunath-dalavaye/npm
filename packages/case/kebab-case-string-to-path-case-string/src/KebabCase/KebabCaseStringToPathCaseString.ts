 ...
 * @example
 * ```typescript
 * KebabCaseStringToPathCaseString('kebab-case-string');
 * ```
 *
 * @example
 ...
 * ```typescript
 * import { KebabCaseStringToPathCaseString } from "@ilihub/code";
 *
 ...
 * npm package to be installed.
 * ```typescript
 * import { KebabCaseStringToPathCaseString } from "@ilihub/case";
 *
 * const string = "hello-world";
 *
 * console.log(KebabCaseStringToPathCaseString(string));
