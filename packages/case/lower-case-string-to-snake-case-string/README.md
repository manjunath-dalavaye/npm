# @ilihub/lower-case-string-to-snake-case-string
...
[![Socket Badge](https://socket.dev/api/badge/npm/package/@ilihub/lower-case-string-to-snake-case-string)](https://socket.dev/npm/package/@ilihub/lower-case-string-to-snake-case-string)
