# @ilihub/header-case-string-to-kebab-case-string
...
[![Socket Badge](https://socket.dev/api/badge/npm/package/@ilihub/header-case-string-to-kebab-case-string)](https://socket.dev/npm/package/@ilihub/header-case-string-to-kebab-case-string)
