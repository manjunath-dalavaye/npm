# @ilihub/lower-case-string-to-sentence-case-string
...
[![Socket Badge](https://socket.dev/api/badge/npm/package/@ilihub/lower-case-string-to-sentence-case-string)](https://socket.dev/npm/package/@ilihub/lower-case-string-to-sentence-case-string)
